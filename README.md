...
| A tool call upstream restates verbatim | Ignored, since gateways resend the whole `tool_calls` array on a later chunk and folding a repeat in would make the arguments unparseable. |
