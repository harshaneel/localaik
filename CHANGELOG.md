...
- One access line per request, logging method, path, status, and latency. Headers and bodies are never logged, and successful `/health` probes are skipped. Set `LK_LOG=off` to silence it.
